...
if  __name__ == '__main__':
    ...
    parser.add_argument('--esHost', type=str, help="The elasticsearch host", required=True)
    parser.add_argument('--esPort', type=int, help="The elasticsearch port", required=True)

    args = parser.parse_args()
    add_elasticsearch(args)
