...
def add_ssh_backup(args):
    ...
    meta_cursor0.execute(stmt, ("ssh_backup", "SSH", args.sshHost, args.sshPort, args.sshUser, args.sshTarget))
...
if  __name__ == '__main__':
    ...
    parser.add_argument('--sshHost', type=str, help="The ssh host", required=True)
    parser.add_argument('--sshPort', type=int, help="The ssh port", required=True)
    parser.add_argument('--sshUser', type=str, help="The ssh user", required=True)
    parser.add_argument('--sshTarget', type=str, help="The ssh TargetDir", required=True)
